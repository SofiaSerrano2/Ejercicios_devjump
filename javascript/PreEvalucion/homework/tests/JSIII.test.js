...
describe('dePalabrasAFrase(words)', function() {
  it('should return a string that has all of the words from the array separated by spaces', function() {
    expect(dePalabrasAFrase(['ProgramacionALaGorra', 'JavaScript', 'Class'])).toBe('ProgramacionALaGorra JavaScript Class');
    expect(dePalabrasAFrase(['ProgramacionALaGorra'])).toBe('ProgramacionALaGorra');
  });
});
